...
// Arrow curving from Left card to Right card
const ArrowRightCurve = () => (
  <svg
    ...
    viewBox="0 0 120 150"
    fill="none"
    className="absolute -bottom-24 left-[calc(50%+20px)] hidden md:block opacity-40"
  >
    <path
...
// Arrow curving from Right card to Left card
const ArrowLeftCurve = () => (
  <svg
    ...
    viewBox="0 0 120 150"
    fill="none"
    className="absolute -bottom-24 right-[calc(50%+20px)] hidden md:block opacity-40"
  >
    <path
...
export default function EventsTimeline() {
  ...
  return (
    <section className="relative z-20 w-full py-24 overflow-hidden">
      {/* THE DARK PORTAL CONTAINER (React Bits Aesthetic) */}
      <div className="container mx-auto px-4 sm:px-8 max-w-7xl">
        <div className="rounded-[3rem] bg-[#060010] p-6 sm:p-12 md:p-20 shadow-[0_0_80px_rgba(123,97,255,0.15)] border border-white/5 relative overflow-hidden">
          {/* Section Header */}
          ...
          <div className="relative flex flex-col gap-20 md:gap-32 mb-32 z-10">
            {regularEvents.map((event, idx) => {
              ...
              return (
                ...
                >
                  {/* Funny Connecting Arrows (Except for the last item pointing to flagship) */}
                  {idx < regularEvents.length - 1 &&
                    (isEven ? <ArrowRightCurve /> : <ArrowLeftCurve />)}
                  {idx === regularEvents.length - 1 && (
                    <ArrowRightCurve /> // Final arrow pointing to Flagship
                  )}
                  ...
                  <motion.div
                    ...
                    className={`w-full md:w-1/2 ${isEven ? "order-1 md:pr-12" : "order-2 md:pl-12"}`}
                  >
          ...
          >
            ...
            <div className="absolute inset-0 z-0">
              <LaserFlow
                color="#7B61FF" // Violet laser
                horizontalBeamOffset={0.1}
                verticalBeamOffset={0.0}
                wispSpeed={isFlagshipHovered ? 40 : 15} // Speed surges on hover
                flowSpeed={isFlagshipHovered ? 1.5 : 0.35} // Flow surges on hover
                wispIntensity={isFlagshipHovered ? 20 : 5} // Beams get brighter on hover
              ...
              <div className="w-full lg:w-[400px] flex justify-center lg:justify-end perspective-[1000px]">
                ...
                >
                  ...
                  <img
                    ...
                    onError={(e) => {
                      // Fallback just in case there are space/URL encoding issues in the filename
