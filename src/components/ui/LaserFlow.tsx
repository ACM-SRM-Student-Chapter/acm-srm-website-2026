...
export default function LaserFlow({
  ...
  useEffect(() => {
    ...
    const renderer = new THREE.WebGLRenderer({
      antialias: false,
      alpha: true, // Set to true to allow transparency if needed
      depth: false,
      stencil: false,
    ...
    renderer.setClearColor(0x060010, 1); // Dark background for the laser
  ...
  useEffect(() => {
    ...
    const { r, g, b } = hexToRGB(color || "#00E5FF");
